...
exports.default = (function () { return describe('vamtiger-organization-welcome-json-ld', function () {
    before(function () {
    ...
    it('load script', function () {
        return __awaiter(this, void 0, void 0, function () {
            var script;
            return __generator(this, function (_a) {
                script = document.head.querySelector('[src="vamtiger-organization-welcome-json-ld.js"]');
